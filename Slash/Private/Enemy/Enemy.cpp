...
AEnemy::AEnemy()
{
	...
	//Note: Ignore warning for unintialized parameters: UPROPERTY reflection system takes care of setting it to nullptr initially
...
void AEnemy::DirectionalHitReact(const FVector& ImpactPoint)
{
	...
	// a*b = |a| |b| * cos(x), take arc(cos(x)) to get angle
